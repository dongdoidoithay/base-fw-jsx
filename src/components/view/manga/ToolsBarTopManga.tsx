...
export function ToolsBarTopManga({ data, current,
                                    ...
                                    <div className="section-header mb-2">
                                        ...
                                        <div className="section-header-title me-auto">
                                            <h2 className="max-caracter-2">
                                                <a href={`${UrlInfo(data.lsDetail?.idDoc, current)}`} title={`${data.lsDetail?.nameDoc} ${data.lsDetail?.nameChapter}`}>{data.lsDetail.nameDoc}</a>
                                            </h2>
